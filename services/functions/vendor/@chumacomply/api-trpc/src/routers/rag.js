    ...
    getComplianceChecklist: publicProcedure
        ...
        try {
            ...
            if (q.includes('email') || q.includes('data')) {
                return {
                    content: 'To operate a digital agency in Zambia and collect user data, you must register with the DataProtection Commissioner. [Source: The Data Protection Act, Sec. 40]',
                    sources: [{ title: 'The Data Protection Act, Sec. 40' }],
                };
            }
            return {
                content: 'To start any business in Zambia, you must first register your business name with PACRA. [Source: The Companies Act, Sec. 12]',
